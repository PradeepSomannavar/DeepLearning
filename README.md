...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Sentence_Transformers-29B5E8?style=for-the-badge&logo=huggingface&logoColor=white" alt="Sentence Transformers" />
  <img src="https://img.shields.io/badge/FAISS-0A66C2?style=for-the-badge&logo=meta&logoColor=white" alt="FAISS" />
...
### ⚡ Optimization & Deployment Techniques
*   **Model Quantization:** Shrinking model size and improving inference speed with quantization techniques (`Quantization_basics.ipynb`).
...
1. Clone the repository:
   ```bash
   git clone https://github.com/PradeepSomannavar/DeepLearning.git
   ```
...
Feel free to explore the code, experiment with different hyperparameters, and learn along with me! 🌟
